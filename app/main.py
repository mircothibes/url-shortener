...
async def create_short_url(
    ...
    """
    Create a new shortened URL with the following features:
...
async def get_url_details(
    ...
    """
    Get detailed information about a specific shortened URL including:
    - Original URL
    - Short code
    - Creation date
    - Click statistics
...
async def get_analytics(
    ...
    """
    Get detailed analytics for a shortened URL including:
    - Total click count
