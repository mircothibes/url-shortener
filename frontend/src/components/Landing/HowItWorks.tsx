 ...
 * Helps users understand the simple workflow. Supports dark mode.
 *
 * Steps:
 * 1. Paste your URL
 * 2. Get short link
...
export const HowItWorks: React.FC = () => {
  return (
     ...
     * bg-slate-50: Light gray background for contrast (dark: slate-800)
     */
    <section id="how" className="py-20 md:py-32 bg-slate-50 dark:bg-slate-800 transition-colors">
